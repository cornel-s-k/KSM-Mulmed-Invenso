        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="<?= base_url('home') ?>">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img src="<?= base_url('assets/images/logo-icon1.jpeg') ?>" height="40" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="<?= base_url('assets/images/logo-icon1.jpeg') ?>" height="40" alt="homepage" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text ml-2">
                        <!-- dark Logo text -->
                        <img src="<?= base_url('assets/images/logo-text1.jpeg') ?>" height="22" width="100" alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->
                        <img src="<?= base_url('assets/images/logo-text1.jpeg') ?>" class="light-logo" height="22" width="100" alt="homepage" />
                    </span>
                </a>
            </div>
            <!-- ============================================================== -->
