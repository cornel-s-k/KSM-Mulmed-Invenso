...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Tambah Supplier</h4>
                    <form action="<?= base_url('supplier') ?>" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <?= form_input('nama', $input->nama, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Nama perusahaan']) ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                        ...
                        <div class="form-actions">
                            <div class="text-right">
                                ...
                                <a href="<?= base_url('supplier/reset') ?>" class="btn btn-dark">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
